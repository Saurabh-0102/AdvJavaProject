...
<body style="background-image: url('food.jpeg'); background-repeat: no-repeat;  background-size: 100% 100%;">
    <div class="container-fluid">
        ...
        <div class="row bg-secondary p-xl-2 text-decoration align-items-center justify-content-center fs-3">Sign-Up Here
        </div>
        <br />

        <div class="container-fluid">
            <div class="row justify-content-center">
                <form action="user_registration.com" onsubmit="return validation()" class="col-xl-6 col-sm-3 col-md-4">
                    ...
                    <button class="btn btn-outline-primary w-50 me-5" type="submit">Sign-Up</button>
