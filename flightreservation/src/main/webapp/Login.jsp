...
<script
	...
	<div class="container-fluid">
		...
		<div
			class="row bg-secondary p-xl-2 text-decoration align-items-center justify-content-center fs-3">
			...
			<form action="login.com" onsubmit="return validation()"
				...
				<div class="form-group">
					<label class="font-weight-regular">Don't have an account
						...
						class=" text-decoration-none" href="http://localhost:8080/Spring-MVC/Registration.jsp">Click here</a>
					</span>
				</div>
