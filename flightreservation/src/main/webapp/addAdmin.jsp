...
<body style="background-image: url('food.jpeg'); background-repeat: no-repeat;  background-size: 100% 100%;">
    <div class="container-fluid">
        ...
        <div class="row bg-secondary p-xl-2 text-decoration align-items-center justify-content-center fs-3">Add New User
        </div>
        <br />

        <div class="container-fluid">
            <div class="row justify-content-center">
                <form action="adminreg.com" onsubmit="return validation()" class="col-xl-6 col-sm-3 col-md-4">
                    <div class="form-group">
                        <label class="font-weight-regular"> Name </label>
                        <input type="text" name="name" class="form-control" id="name" autocomplete="off"
                            placeholder="Enter your goodname here" />
                        <!-- autocomplete? -->
                    ...
                    <div class="form-group mb-lg-3 mb-md-3 ">
                        ...
                        <input type="text" name="number" class="form-control" id="mobileNumber" autocomplete="off"
                            placeholder="mobile number" />
                        <span id="mobileno" class="text-danger font-weight-regular"> </span>
                    </div>
                     <div class="form-group mb-lg-3 mb-md-3 ">
                        <label class="font-weight-regular"> User Type </label>
                        <input type="text" name="role" class="form-control" id="mobileNumber" autocomplete="off"
                            placeholder="admin or user" />
                        <span id="mobileno" class="text-danger font-weight-regular"> </span>
                    </div>

                    <button class="btn btn-outline-primary w-50 me-5" type="submit">Add User</button>
